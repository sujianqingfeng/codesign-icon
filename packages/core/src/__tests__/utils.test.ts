    ...
    expect(data).toMatchInlineSnapshot(`
      {
        "icons": {
          "backtop": {
            "body": "<path fill="#231815" fill-rule="evenodd" d="M5.1 21.624a.6.6 0 01-.6-.6v-1.34a.6.6 0 01.6-.6h13.8a.6.6 0 01.6.6v1.34a.6.6 0 01-.6.6zm6.477-4.447a.55.55 0 00.846 0l6.952-7.95c.233-.265.131-.483-.227-.483h-2.6a.645.645 0 01-.65-.637V3.013a.645.645 0 00-.649-.637H8.751a.645.645 0 00-.65.637v5.094c0 .35-.292.637-.65.637H4.852c-.358 0-.46.218-.227.483z" clip-rule="evenodd"/>",
            "height": 24,
            "width": 24,
          },
        },
        "lastModified": 1715531246,
        "prefix": "base",
      }
    `)
  })
